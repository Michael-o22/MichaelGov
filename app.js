...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 3.4 ปีงบประมาณหลัก (Global Fiscal Year)
    const globalFiscalYearSelect = document.getElementById('global-fiscal-year');
    globalFiscalYearSelect.addEventListener('change', (e) => {
    ...
    function openModal(isEdit = false) {
        if (!isEdit) {
            ...
            document.getElementById('docFiscalYear').value = currentFiscalYear;
    ...
    addDocForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (formFiscalYear !== currentFiscalYear) {
                currentFiscalYear = formFiscalYear;
                globalFiscalYearSelect.value = formFiscalYear;
            }
...
// ==========================================
// 4. การจัดการแสดงผลข้อมูล (Dashboard & Table)
// ==========================================
...
function renderDashboard() {
    const yearData = mockDatabase.filter(d => d.fiscalYear === currentFiscalYear);
...
function renderTable(useAdvanced = false) {
    ...
    let filteredData = mockDatabase.filter(d => d.fiscalYear === currentFiscalYear);
